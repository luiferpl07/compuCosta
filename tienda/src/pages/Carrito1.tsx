            ...
            <div className="flex justify-end border-t border-gray-200 pt-8">
              <div className="w-full lg:w-auto lg:min-w-[400px] space-y-4">
                ...
                <div className="space-y-3">
                  <button
                    disabled
                    className="w-full rounded-md px-8 py-3 text-base font-semibold text-white bg-gray-400 cursor-not-allowed"
                  >
                    Proceder al pago
                  </button>
                  <p className="text-sm text-amber-600 text-center font-medium">
                    El proceso de pago no está disponible en este momento
                  </p>
                </div>
              </div>
            </div>
