...
const links = [
  {
    name: "Inicio",
    href: "/",
    description: "Colecciones máximas de productos de compras.",
    icon: HiMiniQueueList,
  },
  {
    name: "Productos",
    href: "/Producto",
    description: "Encontrarás todos los productos disponibles aquí.",
    icon: HiBookOpen,
  },
  {
    name: "Mi Perfil",
    href: "/perfil",
    description: "Encuentra tu información aquí.",
        ...
        <main className="px-6 pb-16 pt-10 sm:pb-24 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-base leading-7 text-gray-600 sm:mt-6 sm:text-lg sm:leading-8">
              Lo sentimos, no pudimos encontrar la página {path} que estás buscando.
            </p>
          </div>
