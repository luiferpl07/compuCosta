...
const FavoriteProduct = ({ product }: { product: ProductProps }) => {
  const { removeFromFavorite } = store(); // Obtener la función para eliminar de favoritos
  const navigate = useNavigate();

  // Eliminar un producto de favoritos y mostrar un mensaje
  const handleRemoveFromFavorite = () => {
    removeFromFavorite(product._id); // Elimina el producto de favoritos
    toast.success("Eliminado de favoritos con éxito!"); // Muestra un mensaje de éxito
  };
